...
namespace ReunionMovementDLL
{
    ...
    public sealed class ReunionMovementLinkedList<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        /// 初始化游戏框架链表类的新实例。
        /// </summary>
        public ReunionMovementLinkedList()
        {
        ...
        public void RemoveFirst()
        {
            ...
            if (first == null)
            {
                throw new ReunionMovementException("首结点无效。");
            }
        ...
        public void RemoveLast()
        {
            ...
            if (last == null)
            {
                throw new ReunionMovementException("尾结点无效。");
            }
        ...
        public struct Enumerator : IEnumerator<T>, IEnumerator
        {
            ...
            internal Enumerator(LinkedList<T> linkedList)
            {
                if (linkedList == null)
                {
                    throw new ReunionMovementException("链表无效。");
                }
